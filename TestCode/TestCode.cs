...
namespace PetStore.TestCode
{
    public class TestCode
    {
        ...
        //public (Dictionary<string, Product>, List<Product>) TestCodeDict(Dictionary<string, Product> _DogLeash, Dictionary<string, Product> _CatFood, List<Product> _products)
        //{
        ...
        //    _DogLeash.Add(dogLeash1.Name, dogLeash1 as DogLeash);
        ...
        //    _DogLeash.Add(dogLeash2.Name, dogLeash2 as DogLeash);
        ...
        //    _CatFood.Add(catFood1.Name, catFood1 as CatFood);
        ...
        //    _CatFood.Add(catFood2.Name, catFood2 as CatFood);
        ...
        //    _CatFood.Add(catFood3.Name, catFood3 as CatFood);
        ...
        //    _DogLeash.Add(dogLeash3.Name, dogLeash3 as DogLeash);
