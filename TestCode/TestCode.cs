...
namespace PetStore.TestCode
{
    ...
    //    public (Dictionary<string, Product>, List<Product>) TestCodeDict(Dictionary<string, Product> _DogLeash, Dictionary<string, Product> _CatFood)
    //    {
    //        var dogLeashClassTest = new DogLeashLogic();
    ...
    //        dogLeashClassTest.AddDogLeash(dogLeash1);
    ...
    //        dogLeashClassTest.AddDogLeash(dogLeash2);
    ...
    //        catFoodClassTest.AddCatFood(catFood1);
    ...
    //        catFoodClassTest.AddCatFood(catFood2);
    ...
    //        catFoodClassTest.AddCatFood(catFood3);
    ...
    //        dogLeashClassTest.AddDogLeash(dogLeash3);
